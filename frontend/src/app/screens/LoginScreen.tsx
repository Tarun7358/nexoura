      ...
      <div className="w-full max-w-md relative z-10 max-h-[92vh] overflow-y-auto">
        ...
        >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-border bg-input-background py-3 pr-4 pl-12 transition-all focus:ring-2 focus:ring-primary focus:outline-none"
                />
              </div>
            </div>
          ...
          <button
            ...
            className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-border bg-white/10 px-4 py-3 transition-all hover:bg-white/20"
          >
            <span className="inline-flex h-5 w-5 shrink-0 items-center justify-center">
              <svg className="block h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill="#4285F4"
